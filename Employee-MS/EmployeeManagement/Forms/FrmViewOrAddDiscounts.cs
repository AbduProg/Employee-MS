...
{
    public partial class FrmViewOrAddDiscounts : Form
    {
        public FrmViewOrAddDiscounts()
        {
            InitializeComponent();
        }
        //======================Variables====================
        ...
        void GetData()
        {
            SqlConClass.sqlQuery = @"
                                       ...
                                       FROM TblDiscounts D
                                       INNER JOIN TblEmployee E ON D.EmployeeId   =E.Id
                                       INNER JOIN      TblJobs J      ON      E.JobId         =J.Id
                                       INNER JOIN    TblUseres U   ON     D.UserId        =U.Id 
                                       ORDER BY D.DiscountsDate;
                                     ";
        ...
        void FillData()
        {
            if (FunctionsClass.DsHasTables(ds))
            {
                ...
                dgvDiscounts.DataSource = ds.Tables[1];
                dgvDiscounts.ClearSelection(); cmbNamesOfEmployee.Select(); cmbNamesOfEmployee.Focus();
                RefreshVariable();
            }
        }
        ...
        {
            EmployeeId  = DiscountId = 0; cr = -1;
            ds.Tables[1].DefaultView.RowFilter = null;
            FunctionsClass.ApplyDateFormatToDataGridViewColumns(dgvDiscounts);
        ...
        void SaveDiscount()
        {
            ...
            SqlConClass sqlCon = new SqlConClass();
            dsSwap = sqlCon.cmdExecute("InsertForTblDiscounts", param);
            Filldgv(ref dsSwap);
        }
        ...
        private void FrmViewOrAddDiscounts_Load(object sender, EventArgs e)
        {
        ...
        private void dgvDiscounts_Click(object sender, EventArgs e)
        {
            ...
            { return; }
            cr = dgvDiscounts.CurrentRow.Index;
            DiscountId = (int)dgvDiscounts.Rows[cr].Cells[0].Value;
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
                ...
                == DialogResult.Yes)
            {
                ...
                dsSwap = sqlcon.cmdExecute("DeleteForTblDiscounts", para);
                Filldgv(ref dsSwap);
            }
        }
        ...
        private void btnExport_Click(object sender, EventArgs e)
        {
            ...
            FunctionsClass.ExportToExcel(dgvDiscounts, "الخصومات");
        }
